...
namespace _0407_treeview.NorthwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID) ORDER BY Country, City, CustomerID";
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID) ORDER BY Country, City, CustomerID";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_0407_treeview.Properties.Settings.Default.NorthwindConnectionString;
        }
