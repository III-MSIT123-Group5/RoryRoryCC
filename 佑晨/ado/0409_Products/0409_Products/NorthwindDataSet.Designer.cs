...
namespace _0409_Products {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public OrdersRow AddOrdersRow(string CustomerID, EmployeesRow parentEmployeesRowByFK_Orders_Employees, System.DateTime OrderDate, System.DateTime RequiredDate, int ProductID, string ProductName, decimal UnitPrice, short Quantity, float Discount, float Subtotal) {
        ...
        public partial class OrdersRow : global::System.Data.DataRow {
            ...
            public float Subtotal {
                get {
                    try {
                        return ((float)(this[this.tableOrders.SubtotalColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace _0409_Products.NorthwindDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_0409_Products.Properties.Settings.Default.NorthwindConnectionString;
        }
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT          Orders.OrderID, Orders.CustomerID, Orders.EmployeeID, Orders.OrderDate, Orders.RequiredDate, 
                            [Order Details].ProductID, Products.ProductName, [Order Details].UnitPrice, [Order Details].Quantity, 
                            [Order Details].Discount, ([Order Details].UnitPrice * [Order Details].Quantity) * (1 - [Order Details].Discount) 
                            AS Subtotal
