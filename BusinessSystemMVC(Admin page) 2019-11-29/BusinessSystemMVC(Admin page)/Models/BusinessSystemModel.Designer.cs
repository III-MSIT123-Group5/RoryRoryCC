// 已啟用模型 'D:\Github專題\Jocelyn-Chang\RoryRoryCC\BusinessSystemMVC(Admin page) 2019-11-29\BusinessSystemMVC(Admin page)\Models\BusinessSystemModel.edmx' 的 T4 程式碼產生。
