...
namespace EIPBussinessSystem_MVC.Controllers
{
    public class ApprovalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,ApprovalProcedureID,FirstSignerID,FirstSignStatus,SecondSignerID,SecondSignStatus,ThirdSignerID,ThirdSignStatus")] Approval approval)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,ApprovalProcedureID,FirstSignerID,FirstSignStatus,SecondSignerID,SecondSignStatus,ThirdSignerID,ThirdSignStatus")] Approval approval)
        {
            if (ModelState.IsValid)
            {
