...
namespace BusinessSystemMVC_Admin_page_.Controllers
{
    public class ApprovalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApprovalID,OrderID,ApprovalProcedureID,FirstSignerID,FirstSignStatus,SecondSignerID,SecondSignStatus,ThirdSignerID,ThirdSignStatus")] Approval approval)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApprovalID,OrderID,ApprovalProcedureID,FirstSignerID,FirstSignStatus,SecondSignerID,SecondSignStatus,ThirdSignerID,ThirdSignStatus")] Approval approval)
        {
            if (ModelState.IsValid)
            {
